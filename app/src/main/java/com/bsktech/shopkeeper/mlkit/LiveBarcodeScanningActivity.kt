...
import com.bsktech.shopkeeper.mlkit.barcodedetection.BarcodeProcessor
import com.bsktech.shopkeeper.mlkit.barcodedetection.BarcodeResultFragment
...
import com.bsktech.shopkeeper.models.Store
    ...
    private fun setUpWorkflowModel() {
        ...
        workflowModel?.detectedBarcode?.observe(this, Observer { barcode ->
            if (barcode != null) {
                ...
                returnIntent.putExtra("productCode", barcode.rawValue.toString());
